defmodule OpenPair.WeightedMatching do
  @moduledoc """
  ...
  because `OpenPair.Pairing`'s brackets are small in practice (measured:
  ...
  Verified against `OpenPair.Matching`'s exact subset-DP as an
  ...
  safe here because `OpenPair.Pairing`'s packed criterion weights are
