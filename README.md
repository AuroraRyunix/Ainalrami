...
(2026-08-19): 209 players in 1.05 s, 400 in 2.07 s, 1,000 in 7.35 s —
...
own start-up floor, the pairing work is **1.3x to 7.4x quicker than the
C++ reference** and **1.5x to 2.7x slower than the Python one**. A
