defmodule OpenPair.RoundsPlayedTest do
  @moduledoc """
  ...
  (`Z`/`Z`/`Z`/`H`). OpenPair used to compute `rounds_played` as 4, find
  ...
  and returns `4 1` / `2 3`, which is what this test asserts OpenPair now
