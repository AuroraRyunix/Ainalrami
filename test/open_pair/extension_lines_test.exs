defmodule OpenPair.ExtensionLinesTest do
  @moduledoc """
  What the `XXP` and `XXA` extension lines actually do to a pairing.

  `OpenPair.TrfTest` covers reading and writing them; this covers the only
  ...
  engines agree rather than that OpenPair is self-consistent.
  ...
  failure this whole change exists to fix. `OpenPair.Trf` used to parse
  ...
  describe "XXP forbidden pairings" do
    ...
    # Six players, round 4, generated by `OpenPair.Generator` at seed 3 and
