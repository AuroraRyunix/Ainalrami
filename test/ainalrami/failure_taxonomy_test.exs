defmodule Ainalrami.FailureTaxonomyTest do
  @moduledoc """
  Classifies the disagreements `Ainalrami.BbppairingsComparisonTest` counts,
  ...
  test "classifies every Ainalrami/bbpPairings disagreement by its first divergent bracket" do
