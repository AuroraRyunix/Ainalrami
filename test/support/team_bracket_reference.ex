defmodule Ainalrami.Test.TeamBracketReference do
  @moduledoc """
  `Ainalrami.TeamPairing.Bracket`'s 3.6 walk as it was before the 2026-09-16
  speed-up, kept verbatim (module name and this note aside) as a reference.

  The speed-up precomputes what the walk asks and sums the criteria as it
  goes; it must not change a pairing, a candidate count or a step count -
  the budgets depend on the last two. `team_pairing_scale_test.exs` diffs
  the two on generated brackets, budgets included.
  """
